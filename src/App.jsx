    ...
    <section className='description'>
      ...
      <div className="hidden md:flex max-w-2xl bg-white rounded-xl overflow-hidden">
        ...
        <div className="w-1/2 p-8 flex flex-col justify-between">
          <div>
            <h2 className="text-xs font-fraunces text-[#6c7289] font-[700] tracking-[0.6em] mb-4">
              PERFUME
            </h2>
            <h1 className="text-4xl mb-6 font-[700] font-montserrat">
      ...
      <div className="md:hidden w-full max-w-sm bg-white rounded-xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <p className="text-[20px] text-[#6c7289] font-[700] mb-6 leading-relaxed font-fraunces">
            A floral, solar and voluptuous interpretation composed by Olivier
            Polge, Perfumer-Creator for the House of CHANEL.
          </p>
