...
const App = () => {
  return (
    <section className='font-fraunces'>
      ...
      <div className="hidden md:flex max-w-2xl bg-white rounded-xl overflow-hidden">
        ...
        <div className="w-1/2 p-8 flex flex-col justify-between">
          <div>
            ...
            <h1 className="description text-5xl mb-6 font-[700] font-montserrat">
              Gabrielle Essence Eau De Parfum
            </h1>
            <p className="description text-lg font-Fraunces font-[700] mb-6 text-[#6c7289] leading-relaxed ">
          ...
          <div>
            <div className="flex items-center mb-6">
              <p className="text-4xl mr-4 font-[700] font-montserrat text-[#3c8067]">$149.99</p>
              <p className="text-sm font-fraunces font-[500] line-through">$169.99</p>
            </div>
            <button className="description w-full bg-[#3c8067] cursor-pointer hover:bg-[#1b4133] text-white font-fraunces font-[700] py-3 px-4 rounded-lg flex items-center justify-center transition-colors">
      ...
      <div className="md:hidden w-full max-w-sm bg-white rounded-xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center mb-6">
            <p className="text-4xl font-[700] mr-4 font-montserrat text-[#3c8067]">$149.99</p>
            <p className="text-sm font-fraunces font-[500] line-through">$169.99</p>
          </div>
